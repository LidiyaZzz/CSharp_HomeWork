...
/*
    ...
    Следуя из примеровпредполагаемых решений, делаем вывод, что массив может состоять 
    из из количества элементов не превышающих 8. Переформулируем задачу так:
    Напишите программу, которая задаёт массив из СКОЛЬКИ ХОТИТЕ элементов, МОЖНО И ИЗ 8 
    и выводит их на экран., добавим к 
*/
